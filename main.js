...
console.log(chalk.bgBlack(chalk.bold.redBright("Ingresa el número de WhatsApp en el cual estará la Bot\n")))
process.exit(0)
}} else {
while (true) {
numeroTelefono = await question(chalk.bgBlack(chalk.bold.yellowBright('Ingresa el número de WhatsApp en el cual estará la Bot\n')))
